  ...
  const wizardInit = () => {
    ...
    wizards.forEach(wizard => {
      ...
      nextButton.addEventListener(events.CLICK, () => {
        var livraison_name = document.getElementById("livraison_name").value;
        var livraison_checked = document.getElementById("livraison_checked").checked;
        var emballage_checked = document.getElementById("emballage_checked").checked;
        if(livraison_name != ''){
            // COMMANDE
            document.getElementById("val_client").innerHTML = document.getElementById("livraison_name").value;
            // document.getElementById("val_date").innerHTML = document.getElementById("livraison_number").value;
            // document.getElementById("val_statut").innerHTML = 'En cours';
            document.getElementById("val_total").innerHTML = document.getElementById("livraison_total").value;

            // LIVRAISON
            document.getElementById("val_nom_prenom").innerHTML = document.getElementById("livraison_name").value;
            document.getElementById("val_telephone").innerHTML = document.getElementById("livraison_number").value;
            document.getElementById("val_email").innerHTML = document.getElementById("livraison_address").value;
            document.getElementById("val_commentaire").innerHTML = document.getElementById("livraison_comment").value;

            // AUTRE
            if(livraison_checked){
                var livraison_index = document.getElementById("livraison_select").options.selectedIndex;
                document.getElementById("val_lieu").innerHTML = 'Hors Ouaga / '+document.getElementById("livraison_select").options[livraison_index].innerHTML;
                // console.log(document.getElementById("liraison_select").options[livraison_index].innerHTML);
            }
            if(emballage_checked){
                var emballage_index = document.getElementById("emballage_select").options.selectedIndex;
                document.getElementById("val_emballage").innerHTML = 'Oui / '+document.getElementById("emballage_select").options[emballage_index].innerHTML;
            }
            livraison_frais = 2000*parseInt(livraison_index);
            document.getElementById("livraison_frais").value = livraison_frais;
            document.getElementById("val_frais").innerHTML = livraison_frais;
            // document.getElementById("val_tva").innerHTML = document.getElementById("livraison_comment").value;
        }
        // console.log(tabs[count]._element.attributes[1].nodeValue);
        if(tabs[count]._element.attributes[1].nodeValue == "#bootstrap-wizard-validation-tab2"){
            document.getElementById('btn-payment').innerHTML = 'Valider la commande';
        }
        if(tabs[count]._element.attributes[1].nodeValue == "#bootstrap-wizard-validation-tab3"){
            // var post_status = Boolean(document.getElementById("post_status").value);
            if(document.getElementById("post_status").value == 'non'){
                var confirmation = confirm("Voulez vous valider la commande pour un paiement ultérieur?");
                if(confirmation){
                    // SAVE CLIENT DATA
                    var code_cart = document.getElementById("code_cart").value;
                    var livraison_number = document.getElementById("livraison_number").value
                    var livraison_address = document.getElementById("livraison_address").value
                    var livraison_comment = document.getElementById("livraison_comment").value
                    var livraison_select = document.getElementById("livraison_select").value
                    var emballage_select = document.getElementById("emballage_select").value
                    var livraison_date = document.getElementById("livraison_date").value
                    var data_client = 'code_cart='+code_cart+'&livraison_name='+livraison_name+'&livraison_number='+livraison_number+
                                    '&livraison_address='+livraison_address+'&livraison_comment='+livraison_comment+
                                    '&livraison_checked='+livraison_checked+'&emballage_checked='+emballage_checked+'&livraison_select='+livraison_select+
                                    '&emballage_select='+emballage_select+'&livraison_frais='+livraison_frais+'&livraison_date='+livraison_date;

                        // alert(saveCLientData(data_client));
                        if(saveCLientData(data_client) == 'oui'){
                            tabs[count + 1].show();
                         }
                }else{
                    tabs[count + 1].show();
