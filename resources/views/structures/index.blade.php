      ...
      <div class="col col-auto">
        <div class="search-box">
          <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
            <input class="form-control search-input search" type="search" placeholder="Rechercher un structure" aria-label="Search" />
        ...
        <table class="table table-sm fs--1 mb-0">
          <thead>
            <tr>
              ...
              <th class="sort align-middle" scope="col" data-sort="structure_name" style="min-width:200px;">Structure</th>
          ...
          <tbody class="list" id="categories-table-body">
            ...
            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
              ...
              <td class="id align-middle white-space-nowrap">{{ $structure->id }}</td>
              <td class="structure_name align-middle white-space-nowrap align-center"><a class="fw-semi-bold" href="{{ route('structures.edit', $structure->id) }}">{{ $structure->nom_structure }}</a></td>
