        ...
        <table class="table table-sm mb-0" style="font-size: .72rem;">
          <thead>
            <tr>
              ...
              <th class="sort align-middle" scope="col" data-sort="type" style="color: #004ebc;">TYPE</th>
              <th class="sort align-middle" scope="col" data-sort="structure_name" style="color: #004ebc;">STRUCTURE</th>
              <th class="sort align-middle" scope="col" data-sort="structure_name" style="color: #004ebc;">DATE CRÉATION</th>
          ...
          <tbody class="list" id="categories-table-body">
            ...
            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
              ...
              <td class="id align-middle white-space-nowrap fw-bold">{{ $structure->libelle_type }}</td>
              ...
              <td class="structure_name align-middle white-space-nowrap fw-bold">{{ $structure->created_at }}</td>
