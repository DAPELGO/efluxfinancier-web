        ...
        <a class="navbar-brand me-1 me-sm-3" href="{{ route('app.home') }}">
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center"><img src="{{ asset('assets/img/icons/armoirie-bf.png') }}" alt="Armoirie BF" width="24" />
              <p class="logo-text ms-2 d-none d-sm-block">eFlux</p>
            </div>
          </div>
        </a>
        <nav class="mb-2" aria-label="breadcrumb" style="margin: 0.3rem; border-left: 1.5px solid var(--phoenix-navbar-footer-border-color); padding-left: 1rem;">
